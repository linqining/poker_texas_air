...
import dict from '../../context/localization/locales/zh.json';

/**
 * Chinese edition of the whitepaper.
 *
...
const WhitepaperZh: React.FC = () => <WhitepaperBody t={t} />;

export default WhitepaperZh;
